...
t3lib_extMgm::addPlugin(array('LLL:EXT:pae_project/locallang_db.xml:tt_content.list_type_pi1', $_EXTKEY.'_pi1'),'list_type');
...
if (TYPO3_MODE=="BE")	$TBE_MODULES_EXT["xMOD_db_new_content_el"]["addElClasses"]["tx_paeproject_pi1_wizicon"] = t3lib_extMgm::extPath($_EXTKEY).'pi1/class.tx_paeproject_pi1_wizicon.php';
?>